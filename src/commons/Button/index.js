...
const Button = (props) => {
    ...
    const styleClass = {
        primary: {
            button: cx(
                'bg-pwa-button_background hover:bg-primary-400',
                'active:bg-primary disabled:bg-neutral-300 disabled:text-neutral-700 disabled:hover:shadow-none',
        ...
        outlined: {
            button: cx(
                'bg-neutral-white border border-black',
        ...
        disabled: {
            button: cx(
                'focus:shadow-[0_0_0_4px] hover:shadow-lg bg-neutral-200 hover:bg-neutral-200',
