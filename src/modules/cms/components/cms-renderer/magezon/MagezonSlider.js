                ...
                <div className="magezon-slide">
                    ...
                    >
                        ...
                        >
                            ...
                            {caption1 && (
                                <div className="magezon-slide-caption1 text-left" data-animate={caption1_animation}>
                                    <MagezonHeading
                                        text={caption1}
    ...
    return (
        <>
            <div className="magezon-slider group flex flex-col relative">
                {owl_nav ? (
                    <div
                        className={cx('flex', 'justify-between', 'pointer-events-none', {
                            ...
                            'group-hover:opacity-100 absolute w-full top-[50%] -translate-y-[50%] z-[2]':
                ...
                <div className="magezon-slider-inner z-auto rounded-xl overflow-hidden">
